 ...
 * and mapping them to specific error types defined in [com.example.smartschedule.core.domain.errors.employee_error.EmployeeError].
 *
...
suspend inline fun <T> safeDbOperation(
    ...
    return try {
        ...
        Result.Error(_root_ide_package_.com.example.smartschedule.core.domain.errors.employee_error.EmployeeError.DatabaseCorrupted)
    } catch (e: SQLiteDatabaseCorruptException) {
        Result.Error(_root_ide_package_.com.example.smartschedule.core.domain.errors.employee_error.EmployeeError.DatabaseCorrupted)
    } catch (e: Exception) {
        Result.Error(_root_ide_package_.com.example.smartschedule.core.domain.errors.employee_error.EmployeeError.DatabaseError(e))
    }
}
...
fun <T> validateAndWrap(
    ...
    return if (error != null) {
        Result.Error(_root_ide_package_.com.example.smartschedule.core.domain.errors.employee_error.EmployeeError.ValidationError("validation", error))
    } else {
        Result.Success(data)
    }
}
