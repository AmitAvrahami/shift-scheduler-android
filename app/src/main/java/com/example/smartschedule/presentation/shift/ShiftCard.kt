    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text("${shift.startTime.hour}:${shift.startTime.minute.toString().padStart(2, '0')} - ${shift.endTime.hour}:${shift.endTime.minute.toString().padStart(2, '0')}")
